...
// 40 is the width at which a column can still hold the wide bar next to a readable
// slice of the title; below it the compact form keeps both legible. This is the
// upstream final value, so the responsive boundary matches on both sides.
