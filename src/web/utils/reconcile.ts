 ...
 * and a list whose content and order did not change keeps its array. React views
 * subscribed to the store then re-render only for real changes, and a refresh
 * that echoes an already-applied update is a state no-op.
 */
