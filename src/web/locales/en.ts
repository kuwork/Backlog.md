export const en = {
	...
	nav: {
		...
		sortDocsByName: "Title",
		sortDocsById: "ID",
		sortDocsByNameHint: "Sort by title",
		sortDocsByIdHint: "Sort by document ID",
		sortWikiByTitle: "Title",
		sortWikiByFileName: "File name",
		sortWikiByTitleHint: "Sort by title",
		sortWikiByFileNameHint: "Sort by file name",
		sortDecisionsByTitle: "Title",
		sortDecisionsById: "ID",
		sortDecisionsByTitleHint: "Sort by title",
		sortDecisionsByIdHint: "Sort by decision ID",
		decisionsUnavailable: "Decisions unavailable",
	...
	taskDetails: {
		...
		clearCommentsLabel: "Clear",
		clearCommentsConfirm: "Delete all comments? This cannot be undone.",
	...
	milestones: {
		...
		leaveUnassigned: "Clear the milestone field on tasks",
		...
		removeDescription:
			"The milestone file is moved to the archive, and the milestone field of associated tasks is adjusted. Choose how to handle its tasks:",
		addError: "Failed to add milestone",
		addSuccess: (value: string) => `Milestone "${value}" added`,
		archive: "Archive",
		archiveTitle: "Archive Milestone",
		archiveDescription:
			"Only the milestone file will be moved to the archive. Task files will not be modified; tasks will keep their reference to this milestone.",
		...
		noDescription: "No description yet. Click Edit to add one.",
		tasksSection: "Tasks",
		progressLabel: "Progress",
		datesLabel: "Dates",
		loading: "Loading milestone...",
		loadError: "Failed to load milestone",
	},
	...
	settings: {
		...
		defaultAssignee: "Default Assignees",
		defaultAssigneeDesc: "Assignees applied to new tasks when none are provided",
		defaultAssigneePlaceholder: "e.g., @alice",
		labels: "Recommended Labels",
		labelsDesc: "Project recommended label group used for autocomplete when editing task labels",
		labelsPlaceholder: "e.g., bug, frontend, backend",
	...
	graphView: {
		...
		building: "Task graph is building...",
		empty: "The graph has no nodes yet",
		error: "Failed to load the task graph",
		locked: "The task graph is managed by another Backlog instance",
		panUp: "Pan up",
		panDown: "Pan down",
		panLeft: "Pan left",
		panRight: "Pan right",
		zoomIn: "Zoom in",
		zoomOut: "Zoom out",
		fitOverview: "Fit overview",
		keyboardHint: "Arrow keys pan · Ctrl+] zoom in · Ctrl+[ zoom out · Ctrl+0 overview · Esc clears focus",
		mouseHint: "Double-click to open · Click to focus",
		nodesAndEdges: "{1} nodes · {2} edges",
		legendTask: "Task",
		legendCompleted: "Completed",
		legendDraft: "Draft",
		legendMilestone: "Milestone",
		legendWiki: "Wiki page",
		legendDecision: "Decision",
		legendDocument: "Document",
		legendTag: "Tag",
		filterToggle: "Click to filter this kind",
		edgeDependsOn: "Depends on",
		edgeParentOf: "Parent of",
		edgeMilestone: "Belongs to milestone",
		edgeSourcedFrom: "Sourced from",
		edgeLinksTo: "Links to",
		edgeTaggedWith: "Tagged with",
	},
	loadingPhases: {
		...
		loadingLocalBranches: "Loading tasks from local branches...",
		loadingLocalAndRemoteBranches: "Loading tasks from local and remote branches...",
		applyingTaskStates: "Applying latest task states from branch scans...",
		remoteDisabled: "Remote operations disabled - skipping remote tasks",
		fetchingRemoteBranches: "Fetching remote branches...",
		noRecentRemoteBranches: "No recent remote branches found",
		indexingRemoteBranches: "Indexing {1} recent remote branches (last {2} days)...",
		noRemoteTasks: "No remote tasks found",
		foundRemoteTasks: "Found {1} unique tasks across remote branches",
		hydratingRemoteCandidates: "Hydrating {1} remote candidates...",
		hydratingRemoteTasks: "Hydrating {1} remote tasks...",
		loadedRemoteTasks: "Loaded {1} remote tasks",
		indexingLocalBranches: "Indexing {1} other local branches...",
