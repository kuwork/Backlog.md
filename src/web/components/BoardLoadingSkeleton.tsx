	...
	return (
		<div className="relative" role="status" aria-label={t.board.loading}>
			...
			<div className="pointer-events-none absolute inset-0 flex items-center justify-center">
				<span
					className="h-5 w-5 animate-spin motion-reduce:animate-none rounded-circle border-2 border-blue-200 border-t-blue-600 dark:border-blue-400/30 dark:border-t-blue-400"
					aria-hidden="true"
				/>
