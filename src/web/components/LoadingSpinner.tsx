	...
	return (
		<div className={`flex items-center justify-center ${className}`}>
			<div className="flex flex-col items-center space-y-3">
				{/* The ring keeps spinning on hosts that ask for reduced motion: those are the ones with
				    system animations switched off (MinAnimate=0 over RDP, VMs), and a still ring there is
				    indistinguishable from a hung app. Fork divergence from upstream - see BACK-670. */}
