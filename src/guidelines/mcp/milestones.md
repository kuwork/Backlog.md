...
- `milestone_add` — create a milestone with title and optional description, actualStart, actualEnd, and documentation
- `milestone_edit` — rename a milestone and optionally update its date fields, description, and documentation
...
- `documentation` holds documentation URLs or file paths (same semantics as task documentation): `milestone_add` sets it, `milestone_edit` supports `documentation` (replace), `addDocumentation` (append unique), `removeDocumentation` (remove by value), and `documentation: []` to clear.
