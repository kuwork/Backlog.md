...
1. BACK-521.1 - Shared workflow instruction registry and CLI access.
2. BACK-521.2 - Short agent nudge and init default migration.
3. BACK-521.3 - Text input schemas in public command help.
4. BACK-521.4 - Self-correcting CLI errors for agents and humans.
5. BACK-521.5 - Documentation and MCP compatibility updates.
6. BACK-521.6 - Root command local instruction hub.
